...
public class Register extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         **/
        userInput = (EditText) findViewById(R.id.editText5);
        ...
        errorMessage = (TextView) findViewById(R.id.textView7);
/**
 ...
 **/
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (  ( !userInput.getText().toString().equals("")) && ( !passwordInput.getText().toString().equals(""))&& ( !emailInput.getText().toString().equals("")) )
                {
 ...
 **/
    ...
    private class ProcessRegister extends AsyncTask<String,String,JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            uname= userInput.getText().toString();
            ...
            try {
                if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1){
                        ...
                        pDialog.dismiss();
                        errorMessage.setText("Invalid Email id");
                    }
                }
                else{
                    pDialog.dismiss();
                    errorMessage.setText("Error occured in registration");
                }
